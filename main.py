...
Calculate the average freshness of each of the cartons with np.average() and see which one has the lowest average (least fresh).
"""
...
less=min(avg1,avg2,avg3)
print("The least average of the three egg cartons is:", less)
